import{fD as Ie,lf as ae,eo as Ue,gC as $e,K as q,lg as ke,lh as Le,li as Ne,ia as He,lj as qe,lk as Ge,er as x,af as Ve,at as Pe,E as Ce,eD as We,aE as K,eq as Z,eM as Y,k4 as je,ew as oe,ex as Ke,eu as Ye,ju as Xe,jw as Qe,ez as le,hj as Je,jR as Ze,ll as et,lm as tt,s as it,jT as de,ln as rt,_ as ue,jU as st,C as nt,el as at,w as X,P as ot,ak as he,cx as lt,lo as dt,U as ce}from"./index-03fdaeda.js";import{c as ut}from"./ExpandedCIM-70fd77b6.js";import{p as ht,s as ct}from"./imageUtils-2cb29cec.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-bbd2f372.js";import{i as gt}from"./BufferPool-c145eba9.js";import{T as B,E as S,S as $}from"./color-fcdea199.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-ff13a58e.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-bcc3670f.js";import{n as U}from"./programUtils-68f987f9.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-6c65289e.js";import{d as is,y as rs}from"./MagnifierPrograms-6c65289e.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-beee1c8a.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-8884fedb.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-bfe19d6a.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-f12783d4.js";import{r as ns}from"./GraphicsView2D-2d8ca63b.js";import{i as os}from"./GraphicContainer-8a342668.js";import{t as be}from"./requestImageUtils-c10dacac.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-bacca29b.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-45c26196.js";import"./GeometryUtils-3f5786cb.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-574cccf5.js";import"./floatRGBA-f0635df4.js";import"./AttributeStoreView-f16e4fdb.js";import"./TiledDisplayObject-ce6b20e6.js";import"./util-3a5192d7.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-06534eb9.js";import"./featureConversionUtils-69ed4e5d.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-17fe86a6.js";import"./pbf-db87ebb7.js";import"./imageutils-93b12701.js";import"./Matcher-1b2e50e4.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-9d94728c.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-68908d0f.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-6e70baab.js";import"./TimeOnly-a97eea8f.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-602326c9.js";import"./projectionSupport-13d61316.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-6bcc0dae.js";import"./FeatureContainer-0c1883dd.js";import"./TileContainer-ca4bccda.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
