import{fF as Ie,lf as ae,eq as Ue,gC as $e,K as q,lg as ke,lh as Le,li as Ne,ia as He,lj as qe,lk as Ge,et as x,af as Ve,at as Pe,E as Ce,eF as We,aE as K,es as Z,eO as Y,k4 as je,ey as oe,ez as Ke,ew as Ye,ju as Xe,jw as Qe,eB as le,hj as Je,jR as Ze,ll as et,lm as tt,s as it,jT as de,ln as rt,_ as ue,jU as st,C as nt,en as at,w as X,P as ot,ak as he,cz as lt,lo as dt,U as ce}from"./index-cb8c10d0.js";import{c as ut}from"./ExpandedCIM-800e3b93.js";import{p as ht,s as ct}from"./imageUtils-8d55e5ea.js";import{t as _t,b as ft,o as _e,h as mt,i as pt}from"./Container-85b121df.js";import{i as gt}from"./BufferPool-f5e44a0f.js";import{T as B,E as S,S as $}from"./color-ebf39a9d.js";import{g as vt,a as L,h as G,w as A,d as bt,m as xt}from"./WGLContainer-6804eac4.js";import{L as E}from"./enums-fb086c25.js";import{e as wt,a as W,f as ee}from"./ProgramTemplate-4339738f.js";import{n as U}from"./programUtils-bc6831b3.js";import{e as fe,r as yt,t as Tt,a as Ft,m as Bt,J as Et,n as Ot,b as Rt,c as Mt}from"./MagnifierPrograms-42a17b79.js";import{d as is,y as rs}from"./MagnifierPrograms-42a17b79.js";import{h as te,E as C,a as ie,i as Pt}from"./FramebufferObject-80159f0f.js";import{R as v,E as H,F as re,O as j,I as Q,L as D,C as me,D as O,B as se,G as T,U as ne,P as Ct}from"./enums-bdecffa2.js";import{o as pe,N as St}from"./RenderingContext-3b226226.js";import{z as At,q as Dt,Q as zt,E as It,F as Ut,L as N,M as $t,_ as Se,R as ge}from"./definitions-328d54fa.js";import{t as ve}from"./VertexElementDescriptor-2925c6af.js";import{e as R,T as k}from"./Texture-d90263e2.js";import{r as ns}from"./GraphicsView2D-4eff31d4.js";import{i as os}from"./GraphicContainer-8b76bd40.js";import{t as be}from"./requestImageUtils-de23011a.js";import"./BidiEngine-9a40f2f4.js";import"./visualVariablesUtils-1ef3f471.js";import"./OptimizedGeometry-d94e541f.js";import"./GeometryUtils-984e8446.js";import"./enums-f1a6a48a.js";import"./utils-214f8e9b.js";import"./GeometryUtils-67cf8401.js";import"./Rect-ea14f53a.js";import"./quantizationUtils-b480e172.js";import"./floatRGBA-028aa075.js";import"./AttributeStoreView-f57c4151.js";import"./TiledDisplayObject-2b64e00b.js";import"./util-77b54e6c.js";import"./StyleDefinition-29c49b98.js";import"./config-1337d16e.js";import"./earcut-f0ab7973.js";import"./featureConversionUtils-317e3645.js";import"./OptimizedFeatureSet-1d1ac4b9.js";import"./NestedMap-1b5db22e.js";import"./rasterizingUtils-87ec9425.js";import"./pbf-280c2fba.js";import"./imageutils-c778fbfd.js";import"./Matcher-1df389f9.js";import"./tileUtils-c2f19f52.js";import"./TurboLine-0f11baf4.js";import"./CircularArray-ef508845.js";import"./testSVGPremultipliedAlpha-f1fece6b.js";import"./throttle-7bf02de9.js";import"./ComputedAttributeStorage-82dd5a77.js";import"./TimeOnly-c5d299c6.js";import"./OrderIndependentTransparency-6ae10952.js";import"./basicInterfaces-11f56cb3.js";import"./doublePrecisionUtils-e3c3d0d8.js";import"./normalizeUtilsSync-0dfcf0d7.js";import"./projectionSupport-276693a5.js";import"./json-48e3ea08.js";import"./BaseGraphicContainer-9f13a3fe.js";import"./FeatureContainer-369d9021.js";import"./TileContainer-9fad44e6.js";import"./vec3f32-2da9db36.js";let kt=class{constructor(){this._resourceMap=new Map,this._inFlightResourceMap=new Map,this.geometryEngine=null,this.geometryEnginePromise=null}destroy(){this._inFlightResourceMap.clear(),this._resourceMap.clear()}getResource(e){return this._resourceMap.get(e)??null}async fetchResource(e,t){const i=this._resourceMap.get(e);if(i)return{width:i.width,height:i.height};let r=this._inFlightResourceMap.get(e);return r?r.then(n=>({width:n.width,height:n.height})):(r=ht(e,t),this._inFlightResourceMap.set(e,r),r.then(n=>(this._inFlightResourceMap.delete(e),this._resourceMap.set(e,n),{width:n.width,height:n.height}),()=>({width:0,height:0})))}deleteResource(e){this._inFlightResourceMap.delete(e),this._resourceMap.delete(e)}loadFont(e){return ut(e)}},Lt=class{constructor(e){this.events=new Ie,this._hasMajorPerformanceCaveat=!1,this._lastRenderFrameCounter=0,this._canvas=document.createElement("canvas"),this._canvas.setAttribute("style","width: 100%; height:100%; display:block; willChange:transform");const t={failIfMajorPerformanceCaveat:!0,alpha:!0,antialias:!1,depth:!0,stencil:!0};e.appendChild(this._canvas);let i=ae("2d",this._canvas,t);i||(i=ae("2d",this._canvas,{...t,failIfMajorPerformanceCaveat:!1}),this._hasMajorPerformanceCaveat=!0),this._gl=i,this._handles=Ue([$e(this._canvas,"webglcontextlost",r=>this.events.emit("webgl-context-lost",r))])}destroy(){var e;(e=this._canvas.parentNode)==null||e.removeChild(this._canvas),this._canvas=null,this._handles.remove(),this._gl=null}get gl(){return this._gl}render(e,t){if(this._hasMajorPerformanceCaveat||q("esri-force-performance-mode")){if(++this._lastRenderFrameCounter>=q("esri-performance-mode-frames-between-render")&&(t(),this._lastRenderViewState=e.state.clone(),this._lastRenderFrameCounter=0),this._lastRenderViewState){const[i,r,n,s,a,o]=this._computeViewTransform(this._lastRenderViewState,e.state);this._canvas.style.transform=`matrix(${i}, ${r}, ${n}, ${s}, ${a}, ${o})`}}else t()}resize(e){const t=this._canvas,i=t.style,{state:{size:r},pixelRatio:n}=e,s=r[0],a=r[1],o=Math.round(s*n),d=Math.round(a*n);t.width===o&&t.height===d||(t.width=o,t.height=d),i.width=s+"px",i.height=a+"px"}_computeViewTransform(e,t){const[i,r]=e.center,[n,s]=t.center,[a,o]=e.toScreen([0,0],n,s),[d,u]=e.toScreen([0,0],i,r),h=d-a,_=u-o,m=e.scale/t.scale,g=t.rotation-e.rotation,f=Ge();return ke(f),Le(f,f,[m,m]),Ne(f,f,He(g)),qe(f,f,[h,_]),f}};const Nt={background:{"background.frag":`#ifdef PATTERN
